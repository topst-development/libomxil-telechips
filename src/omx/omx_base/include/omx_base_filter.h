...
#ifndef OMX_BASE_FILTER_H__
#define OMX_BASE_FILTER_H__
...
#define OMX_OUTPORT_INDEX_TWO 2
#define OMX_OUTPORT_INDEX_THREE 3
...
#define omx_base_filter_PrivateType_FIELDS omx_base_component_PrivateType_FIELDS \
  ...
  /** @param newbuffer flag */ \
  OMX_BOOL isNewInputBuffer; \
  /** @param delayedOutputBufferCount delayed Output Buffer count */ \
  OMX_S32 delayedOutputBufferCount; \
