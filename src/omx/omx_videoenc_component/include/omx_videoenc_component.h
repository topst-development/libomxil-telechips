...
#ifndef OMX_VIDEOENC_COMPONENT_H_
#define OMX_VIDEOENC_COMPONENT_H_
...
#define omx_videoenc_component_PrivateType_FIELDS omx_base_filter_PrivateType_FIELDS \
  ...
  /** @param video encoder specific parameters */ \
  OMX_VIDEO_PARAM_PROFILELEVELTYPE    sProfileLevel;  \
  OMX_CONFIG_ROTATIONTYPE             stRotationType;  \
  OMX_VIDEO_PARAM_ERRORCORRECTIONTYPE stErrCorrectionType;  \
  OMX_VIDEO_PARAM_BITRATETYPE         stBitrateType;  \
  OMX_VIDEO_PARAM_QUANTIZATIONTYPE    stQuantType;  \
  OMX_VIDEO_PARAM_VBSMCTYPE           stVBSMCType;  \
  OMX_VIDEO_PARAM_MOTIONVECTORTYPE    stMotionVectorType; \
  OMX_VIDEO_PARAM_INTRAREFRESHTYPE    stIntraRefreshType;  \
  OMX_VIDEO_PARAM_AVCSLICEFMO         stAvcSliceFMOType;  \
  OMX_CONFIG_FRAMERATETYPE            stFrameRateType;  \
  OMX_VIDEO_CONFIG_BITRATETYPE        stBitRateType;  \
  OMX_CONFIG_INTRAREFRESHVOPTYPE      stIntraRefreshVop; \
  /** @param for vpu instance handle/index */ \
  ...
  /*pmap_t              mUmpRmap; */\
  void*               mMapInfo_umpR; \
  OMX_BOOL            bSwap_input; \
  BUFFER_TYPE         BufferType; \
  OMX_S32             mCopy_fd; \
  OMX_U32             nFrameCount; \
  OMX_BOOL            bSeenEOS; \
  cdk_func_t*         gspfVEnc; \
  OMX_S8              mBitstreamFormat; \
...
OMX_ERRORTYPE omx_videoenc_component_Constructor(
...
#endif // OMX_VIDEOENC_COMPONENT_H_
